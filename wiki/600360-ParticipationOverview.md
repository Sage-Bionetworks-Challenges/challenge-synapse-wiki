...
1. After you have registered for a Synapse account, you must register for the Challenge.  By registering, you agree to abide by all the [**Rules**](#!Synapse:syn18058986/wiki/588172) set forth by DREAM and the specifics for this Challenge.
...
Click [**here**](https://www.synapse.org/#!Map:0) to see where the world solvers are coming from. 
...
${registerChallengeTeam?challengeId=0&buttonText=Register your Team}

### Join an Existing Team
You may also request to join an existing team that is already registered for this Challenge. Visit the [**Participants and Teams**](#!Synapse:syn18058986/wiki/588175) page to see all registered teams.  Learn more about [**joining a team**](https://docs.synapse.org/articles/teams.html#join-a-team).

## **Step 3. Access the Data**

 You can access the Challenge data once you have registered and have become a Certified User, in addition to accepting all the conditions of use of the data.  Learn more about the [**Data**](#!Synapse:syn18058986/wiki/588177) available.
...
1.  An executable Docker container that contains the participant's model or a prediction file.   View [**File Submission**](#!Synapse:syn18058986/wiki/590970) and [**Docker Submission**](#!Synapse:syn18058986/wiki/588179).
1.  A **public** Synapse Project that contains a writeup of their methods and source code.  For most Challenges, this will be submitted after the final submissions. View [**Writeup Submission**](#!Synapse:syn18058986/wiki/594661).
...
The [**Discussion Forum**](#!Synapse:syn18058986/discussion/default) should be used for:
